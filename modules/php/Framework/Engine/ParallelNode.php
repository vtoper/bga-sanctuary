...
class ParallelNode extends AbstractNode
{
  public function __construct($info = [], $children = [])
  {
    ...
    $this->info['type'] = Engine::NODE_PARALLEL;
  }
  ...
  /**
   * A PARALLEL node is doable if all its mandatory children are doable (or if the PARALLEL node itself is optional)
   */
  ...
  /**
   * A PARALLEL node is optional if all its mandatory children are already done
   */
