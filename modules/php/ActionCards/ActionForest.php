...
class ActionForest extends \Bga\Games\sanctuary\Models\ActionCard
{
  public function __construct($row)
  {
    ...
    $this->actionType = 'Forest';
    $this->descI = [clienttranslate('Maximum animal level'), clienttranslate('Play 1 Animal with the habitat FOREST or undefined'),  clienttranslate('Draw 2 tiles from the pile')];
    $this->descII = [clienttranslate('Maximum animal level'), clienttranslate('Play 1 or 2 Animals with the habitat FOREST or undefined'),  clienttranslate('Draw 2 tiles from the pile')];
    $this->tooltip = [
      clienttranslate('TBD')
    ];
  }
